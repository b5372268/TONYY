...
<table id="table-1">
	<tr><td>
		 ...
		 <h4><a href="<%=request.getContextPath()%>/front-end/comment/select_comment_page.jsp"><img src="<%=request.getContextPath()%>/comment_images/comment1.jpg" width="100" height="100" border="0">回首頁</a></h4>
	</td></tr>
</table>
...
<table>
	...
	<tr>
		...
		<td><input type="TEXT" name="content" size="45"
			 value="<%= (commentVO==null)? "喔嗨唷" : commentVO.getContent()%>" /></td>	</tr>
