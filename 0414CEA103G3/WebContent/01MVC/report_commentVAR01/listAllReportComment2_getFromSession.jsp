...
<%
   // List<ReportCommentVO> list = (List<ReportCommentVO>)session.getAttribute("list"); //ReportCommentServlet.java(Concroller), 存入session的list物件
%> 
...
<html>
<head>
<title>所有檢舉評論資料 - listAllReportComment2_getFromSession.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>所有檢舉評論資料 - listAllReportComment2_getFromSession.jsp</h3>
